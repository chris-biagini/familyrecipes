...
Edit `lib/mirepoix/ai_import_prompt_faithful.md`. Rules:
...
Commit the change:
    ...
    git add lib/mirepoix/ai_import_prompt_faithful.md
...
2. Restore the best prompt:
       ...
       git show <prompt_sha> > lib/mirepoix/ai_import_prompt_faithful.md
