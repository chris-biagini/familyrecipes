...
- Name: navigation.spec.mjs >> Navigation flows >> search overlay opens and closes
- Location: test/release/exploratory/navigation.spec.mjs:45:3
...
- generic [ref=e1]:
  - navigation [ref=e2]:
    ...
    - button "Search recipes" [active] [ref=e30] [cursor=pointer]:
      - img [ref=e31]
